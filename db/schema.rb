...
ActiveRecord::Schema[7.1].define(version: 2024_11_03_144501) do
  ...
  create_table "diaries", force: :cascade do |t|
    ...
    t.index ["diary_date", "user_id"], name: "index_diaries_on_diary_date_and_user_id", unique: true
  ...
  create_table "likes", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["diary_id", "user_id"], name: "index_likes_on_diary_id_and_user_id", unique: true
